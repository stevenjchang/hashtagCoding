...
const CraigslistJobsListItem = ({ item, toggleShowHide }) => {
  return (
        ...
        <div className="panel-heading">
          <a href={item.href} target="_blank">
            <p className="panel-title listing-title">
              {item.title}
              <span className="listing-title-neighborhood"> ~ ( {item.neighborhood ? item.neighborhood : 'no location'} )
              </span>
            </p>
          </a>
        </div>
...
export default CraigslistJobsListItem;
